...
if __name__ == "__main__":
    ...
    questions, answers = load_queries("/root/autodl-tmp/schlink/BIRD_Data/data/dev_20240627/dev.json")
    ...
    if len(predicted) != len(answers):
        ...
        with open("/root/autodl-tmp/schlink/BIRD_Data/data/dev_20240627/cache/dev_predicted_tables_baseline_Qwen3.json", "w", encoding="utf-8") as f:
            json.dump({"questions": questions, "predicted_tables": predicted, "answers": answers}, f, ensure_ascii=False, indent=4)
            print("数据保存完成！保存到 /root/autodl-tmp/schlink/BIRD_Data/data/dev_20240627/cache/dev_predicted_tables_baseline_Qwen3.json")
